...
@Composable
fun PreferenceHeader(title: String, modifier: Modifier = Modifier, tonalElevation: Dp = 0.dp) {
...
fun Preference(
    ...
    Surface(modifier = modifier, onClick = { onClick?.invoke() }) {
        Row(
