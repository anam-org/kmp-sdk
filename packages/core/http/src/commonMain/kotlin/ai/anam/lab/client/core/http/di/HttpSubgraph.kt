...
interface HttpSubgraph {
    ...
    fun providesHttpClient(authRepository: AuthRepository, logger: Logger, apiHttpConfig: ApiHttpConfig): HttpClient =
        buildApiHttpClient(
            baseUrl = apiHttpConfig.baseUrl,
            requestTimeoutMs = apiHttpConfig.requestTimeoutMs,
    ...
    @Provides
    @SingleIn(AppScope::class)
    fun providesKtorfit(httpClient: HttpClient, apiHttpConfig: ApiHttpConfig): Ktorfit = Ktorfit.Builder()
